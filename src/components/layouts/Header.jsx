...
const Header = ({ onSearch }) => {
  ...
  return (
    <div>
      ...
      {/* Side Bar */}
      <Card className="fixed top-[4rem] left-0 h-[calc(100vh-4rem)] w-[5.5rem] p-1 bg-[#333333] rounded-none shadow-s border-none">
        <TailwindList>
          <ListItem
            className={`text-[#FFFAFA] p-2 w-[4rem] flex flex-col items-center justify-center hover:text-blue-500 hover:bg-gray-800  focus:bg-transparent active:bg-transparent focus:text-blue-500 active:text-blue-500 ${isActive('/')}`}
            onClick={handleFormClick}
          >
            <ListItemPrefix>
              <WorkHistory className="ml-4" />
            </ListItemPrefix>
            <Link to="/" className="text-xs hover:text-blue-500 focus:text-blue-500 active:text-blue-500">Form</Link>
          </ListItem>

          <ListItem
            className={`text-[#FFFAFA] p-1 w-[4rem] flex flex-col items-center justify-center hover:text-blue-500 hover:bg-gray-800 focus:bg-transparent active:bg-transparent focus:text-blue-500 active:text-blue-500 ${isActive('/updates')}`}
            onClick={handleUpdatesClick}
          >
            <ListItemPrefix>
              <ListIcon fontSize="large" className="ml-4" />
            </ListItemPrefix>
            <Link to="/updates" className="text-xs ml-[4px] mt-[-6px] hover:text-blue-500 focus:text-blue-500 active:text-blue-500">Updates</Link>
          </ListItem>
          ...
          >
            ...
            <Link to="#" className="text-xs hover:text-blue-500 focus:text-blue-500 active:text-blue-500">Settings</Link>
          </ListItem>
